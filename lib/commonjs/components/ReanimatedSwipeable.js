...
const Swipeable = /*#__PURE__*/(0, _react.forwardRef)(function Swipeable(props, ref) {
  ...
  const dispatchImmediateEvents = (0, _react.useCallback)((fromValue, toValue) => {
    ...
    if (toValue > 0 && onSwipeableWillOpen) {
      ...
      (0, _reactNativeReanimated.runOnJS)(onSwipeableWillClose)(fromValue > 0 ? SwipeDirection.LEFT : SwipeDirection.RIGHT, fromValue > 0 ? showLeftProgress.value : showRightProgress.value);
    }
  }, [onSwipeableWillClose, onSwipeableWillOpen, showLeftProgress.value, showRightProgress.value]);
